...
class MusicClassificationPipeline:
    ...
    def __init__(
        ...
        self.data_loader = MusicDataLoader(
            dataset_name=dataset_name, samples_per_class=samples_per_class
        )
    ...
    def train_model(
        self, dataset_dict: Dict, training_args: Optional[Dict] = None
    ) -> Dict:
        """
        Train the model
        ...
        return {"trainer": trained_trainer, "training_history": training_history}

    def evaluate_model(self, trainer, dataset_dict: Dict) -> Dict:
        """
    ...
    def create_visualizations(
        self, evaluation_results: Dict, training_history: List[Dict]
    ) -> None:
        """
